  ...
  return (
    <div className="min-h-screen bg-[#F1F6F9]">
      ...
      <div className="min-h-screen bg-[#F1F6F9] flex items-center justify-center p-4 pt-24 pb-8 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-72 h-72 sm:w-96 sm:h-96 bg-[#9BA4B4] rounded-full mix-blend-multiply filter blur-3xl opacity-10"></div>
        <div className="absolute bottom-0 right-0 w-72 h-72 sm:w-96 sm:h-96 bg-[#9BA4B4] rounded-full mix-blend-multiply filter blur-3xl opacity-10"></div>
