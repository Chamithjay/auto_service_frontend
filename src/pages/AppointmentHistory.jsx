...
const AppointmentHistory = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F1F6F9]">
      ...
      />
      <div className="max-w-6xl mx-auto p-6 lg:ml-64 pt-20">
            ...
            <table className="min-w-full table-auto">
              <thead>
                <tr className="text-left border-b">
                  ...
                  <th className="px-4 py-2 text-sm text-[#394867]">
                    Created At
                  </th>
                  <th className="px-4 py-2 text-sm text-[#394867]">
                    Appointment Date
              ...
              <tbody>
                {appointments.map((a) => (
                  ...
                  >
                    <td className="px-4 py-3 text-sm text-[#14274E]">
                      {a.appointmentId}
                    </td>
                    <td className="px-4 py-3 text-sm text-[#14274E]">
                    ...
                    <td className="px-4 py-3 text-sm text-[#14274E]">
                      {a.totalCost ? `$${Number(a.totalCost).toFixed(2)}` : "-"}
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        <div className="mt-6 flex justify-end">
          <button
            onClick={() => navigate(-1)}
            className="px-4 py-2 bg-[#14274E] text-white rounded-lg hover:bg-[#394867]"
          >
            Back
          </button>
        </div>
