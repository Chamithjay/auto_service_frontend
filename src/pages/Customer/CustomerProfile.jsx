...
const CustomerProfile = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.phoneNumber && (formData.phoneNumber.length < 9 || formData.phoneNumber.length > 20)) {
      newErrors.phoneNumber = "Phone number must be between 9 and 20 characters";
    }
  ...
  return (
    <CustomerDashboardLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        {/* Page Header */}
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-[#14274E]">My Profile</h1>
          ...
          <div className="p-6 sm:p-8">
            {!isEditing ? (
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="font-semibold text-[#14274E] text-lg">{profile?.username}</p>
                  </div>
                  <div>
                    <p className="text-sm text-[#9BA4B4] mb-1">Email</p>
                    <p className="font-semibold text-[#14274E] text-lg">{profile?.email}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-[#14274E] text-lg">Customer</p>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-[#9BA4B4]/20">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-semibold text-[#14274E]">{profile?.createdAt}</p>
                    </div>
                    <div>
                      <p className="text-[#9BA4B4]">Last Updated</p>
                      <p className="font-semibold text-[#14274E]">{profile?.updatedAt}</p>
                    </div>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                {/* Username */}
                <div>
                  <label htmlFor="username" className="block text-sm font-semibold text-[#14274E] mb-2">
                ...
                {/* Email */}
                <div>
                  <label htmlFor="email" className="block text-sm font-semibold text-[#14274E] mb-2">
                ...
                {/* Phone Number */}
                <div>
                  <label htmlFor="phoneNumber" className="block text-sm font-semibold text-[#14274E] mb-2">
                    Phone Number
                  </label>
                  <input
                    id="phoneNumber"
