...
import { addVehicle, updateVehicle, getVehicleById } from "../../api/Api";
...
const VehicleForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.registrationNo.trim()) {
      ...
      newErrors.registrationNo = "Registration number must not exceed 255 characters";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response && error.response.data) {
        ...
        setErrors({
          general: `Failed to ${isEditMode ? "update" : "add"} vehicle. Please try again.`,
        });
      }
    } finally {
      setIsLoading(false);
      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Vehicle Name */}
            <div>
              <label htmlFor="vehicleName" className="block text-sm font-semibold text-[#14274E] mb-2">
            ...
            {/* Registration Number */}
            <div>
              <label htmlFor="registrationNo" className="block text-sm font-semibold text-[#14274E] mb-2">
              ...
              <input
                ...
                onChange={handleChange}
                className={`appearance-none block w-full px-4 py-3 border ${
                  errors.registrationNo ? "border-red-400" : "border-[#9BA4B4]/30"
                } rounded-xl bg-[#F1F6F9] text-[#14274E] placeholder-[#9BA4B4] focus:outline-none focus:ring-2 focus:ring-[#394867] focus:border-transparent transition-all duration-300`}
            ...
            {/* Vehicle Type */}
            <div>
              <label htmlFor="vehicleType" className="block text-sm font-semibold text-[#14274E] mb-2">
            ...
            {/* Model */}
            <div>
              <label htmlFor="model" className="block text-sm font-semibold text-[#14274E] mb-2">
                Model (Optional)
              </label>
              <input
                id="model"
