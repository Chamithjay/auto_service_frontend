...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F1F6F9]">
      ...
      <div className="h-screen bg-[#F1F6F9] flex items-center justify-center p-4 relative overflow-hidden">
        {/* Decorative Elements */}
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                <h2 className="text-center text-3xl font-extrabold text-[#14274E] mb-2">
                  Welcome Back
                </h2>
                <p className="text-center text-[#394867] mb-6">
